...
$$
\mathbf{y} = \mathbf{g} + \mathbf{g}_{M} + \mathbf{e},
\qquad
\mathbf{g_M} \sim \mathcal{N}(\mathbf{0},\; \sigma_g^2 \mathbf{G_M})
$$
...
- a direct component based on $\mathbf{G} =$ `Goo`
- a maternal indirect component based on $\mathbf{G}_{M} =$ `Gmm`
- a covariance component for overlap between direct and maternal effects: `Dom`
